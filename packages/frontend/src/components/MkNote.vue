	...
	<article v-else :class="$style.article" @contextmenu.stop="onContextmenu">
		...
		<div :class="$style.main">
			...
			<div style="container-type: inline-size;">
				...
				<div v-show="appearNote.cw == null || showContent" :class="[{ [$style.contentCollapsed]: collapsed }, {[$style.notecontentOverflow]: defaultStore.state.overflowLongNotes}]">
			...
			<footer :class="$style.footer">
				<button v-if="canReply" :class="$style.footerButton" class="_button" @click="reply()">
				...
				<button v-if="defaultStore.state.showClipButtonInNoteFooter && ($i?.policies.clipAvailable || $i?.isAdmin)" ref="clipButton" :class="$style.footerButton" class="_button" @mousedown.prevent="clip()">
...
const canRenote = computed(() => ($i?.policies.canQuote ?? true) && (['public', 'home'].includes(appearNote.value.visibility) || (appearNote.value.visibility === 'followers' && appearNote.value.userId === $i?.id)));
const canReply = computed(() => ($i?.policies.canReply ?? true) || (note.value.userId === $i?.id));
